...
.2 => rb.gain; .2 => rb.mix; .4 => float vel_bass;
cb.clear( 1.0 );
cb.controlChange( 2, 90 ); // reed stiffness
cb.controlChange( 4, 40 ); // noise gain
cb.controlChange( 11, 65 ); // vibrato freq
cb.controlChange( 1, 40 ); // vibrato gain
cb.controlChange( 128, 80 ); // vibrato gain

//melody line clarinet ugen
Clarinet ct => JCRev rt => dac;
.5 => rt.gain; .1 => rt.mix; .3 => float vel_treb;
ct.clear( 1.0 ); // clear
...
//while (true) {
    ...
    // mm9-12
    construct_phrase(bass3, treb3, vel_bass, vel_treb, dur_8th, 0.05*2);
    construct_phrase(bass4, treb4, vel_bass, vel_treb, dur_16th, 0.2*2); construct_phrase(bass4, treb4, vel_bass, vel_treb, dur_16th, 0.25*2);
    construct_phrase(bass5, treb5, vel_bass, vel_treb, dur_8th, 0.15*2);
    construct_phrase(bass6, treb6, vel_bass, vel_treb, dur_16th, 0.3*2); construct_phrase(bass6, treb6, vel_bass, vel_treb, dur_16th, 0.35*2);
    // mm13-16
    construct_phrase(bass3, treb3, vel_bass, vel_treb, dur_8th, 0.12*2);
    construct_phrase(bass4, treb4, vel_bass, vel_treb, dur_16th, 0.3*2); construct_phrase(bass4, treb4, vel_bass, vel_treb, dur_16th, 0.35*2);
    construct_phrase(bass6, treb6, vel_bass, vel_treb, dur_16th, 0.35*2); construct_phrase(bass6, treb7, vel_bass, vel_treb, dur_16th, 0.40*2);
    construct_phrase(bass6, treb8, vel_bass, vel_treb, dur_16th, 0.45*2); 
    //mm17-18
    construct_phrase(bass_g, treb_g90, vel_bass, vel_treb, dur_8th, 0.6*2);
    construct_phrase(treb_desc, treb_desc, vel_bass, vel_treb, dur_8th, 0.6*2);
    //mm19-22
    construct_phrase(bass_c48, treb1, vel_bass, vel_treb, dur_8th, 0.1*2);
    construct_phrase(bass_g43, treb2, vel_bass, vel_treb, dur_8th, 0.2*2);
    construct_phrase(bass_ab56, treb21, vel_bass, vel_treb, dur_8th, 0.15*2);
    construct_phrase(bass_eb51, treb1, vel_bass, vel_treb, dur_8th, 0.1*2);
    //mm23-26
    construct_phrase(bass_c48, treb1, vel_bass, vel_treb, dur_8th, 0.1*2);
    construct_phrase(bass_g43, treb2, vel_bass, vel_treb, dur_8th, 0.05*2);
    construct_phrase(bass_c48, treb_whole, vel_bass, vel_treb, dur_end, 0.01*2);
